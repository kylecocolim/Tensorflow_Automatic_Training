...
import cv2
import random
def dataset(csvPath,batch_size,inputShape):
    ...
    trainDataset = image_gen.flow_from_dataframe(filelist,batch_size=batch_size ,target_size=inputShape)
    testDataset = image_gen.flow_from_dataframe(test,inputShape)
